fetch("http://10.161.112.160:3002/getSgdOilPrice")
...
function convertAndDisplayResult() {
  ...
  const apiUrl = `http://10.161.112.160:3002/getConvertBarreltoLiter?barrel=${barrelValue}`;
  const litUrl = `http://10.161.112.160:3002/getConvertLitertoBarrel?litter=${litValue}`;
